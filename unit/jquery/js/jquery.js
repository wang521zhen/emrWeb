		...
		function(e, t) {
				...
				if(B && !r) {
					if(i = Ce.exec(e))
						if(a = i[1]) {
							...
							if((a = i[3]) && S.getElementsByClassName && t.getElementsByClassName) return ie.apply(n, t.getElementsByClassName(a)), n
						}
					if(S.qsa && (!P || !P.test(e))) {
						if(f = c = I, p = t, d = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
							for(u = g(e), (c = t.getAttribute("id")) ? f = c.replace(Ee, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", l = u.length; l--;) u[l] = f + m(u[l]);
							p = ye.test(e) && t.parentNode || t, d = u.join(",")
						}
						if(d) try {
			...
			function g(e, t) {
				...
				for(s = e, l = [], u = j.preFilter; s;) {
					...
					for(a in j.filter) !(i = Te[a].exec(s)) || u[a] && !(i = u[a](i)) || (r = i.shift(), o.push({
						value: r,
						type: a,
						matches: i
					}), s = s.slice(r.length));
			...
			function y(e, t, n) {
				...
				return t.first ? function(t, n, o) {
					...
					if(a) {
						...
						for(; t = t[r];)
							if(1 === t.nodeType || i)
								if(u = t[I] || (t[I] = {}), (l = u[r]) && l[0] === c) {
									if((s = l[1]) === !0 || s === A) return s === !0
								} else if(l = u[r] = [c], l[1] = e(t, n, a) || A, l[1] === !0) return !0
				}
			}
			...
			function x(e, t, n, r, i, a) {
				return r && !r[I] && (r = x(r)), i && !i[I] && (i = x(i, a)), o(function(o, a, s, l) {
					var u, c, f, p = [],
						d = [],
						h = a.length,
						g = o || C(t || "*", s.nodeType ? [s] : s, []),
						m = !e || !o && t ? g : b(g, p, e, s, l),
						y = n ? i || (o ? e : h || r) ? [] : a : m;
					if(n && n(m, y, s, l), r)
						for(u = b(y, d), r(u, [], s, l), c = u.length; c--;)(f = u[c]) && (y[d[c]] = !(m[d[c]] = f));
					if(o) {
						if(i || e) {
							if(i) {
							...
							for(c = y.length; c--;)(f = y[c]) && (u = i ? ae.call(o, f) : p[c]) > -1 && (o[u] = !(a[u] = f))
						}
					} else y = b(y === a ? y.splice(h, y.length) : y), i ? i(null, a, y, l) : ie.apply(a, y)
				})
			}

			function T(e) {
				for(var t, n, r, i = e.length, o = j.relative[e[0].type], a = o || j.relative[" "], s = o ? 1 : 0, l = y(function(e) {
						return e === t
					}, a, !0), u = y(function(e) {
					...
					if(n = j.relative[e[s].type]) c = [y(v(c), n)];
					else {
						if(n = j.filter[e[s].type].apply(null, e[s].matches), n[I]) {
							...
							return x(s > 1 && v(c), s > 1 && m(e.slice(0, s - 1).concat({
								value: " " === e[s - 2].type ? "*" : ""
							})).replace(he, "$1"), n, r > s && T(e.slice(s, r)), i > r && T(e = e.slice(r)), i > r && m(e))
						}
						c.push(n)
					}
				return v(c)
				...
				var r = 0,
					...
					s = function(o, s, l, u, c) {
						...
						if(g += m, i && m !== g) {
							...
							ie.apply(u, h), v && !o && h.length > 0 && g + t.length > 1 && n.uniqueSort(u)
						}
						return v && (X = w, q = x), y
					};
				return i ? o(s) : s
			...
			function N(e, t, n, r) {
				var i, o, a, s, l, u = g(e);
				if(!r && 1 === u.length) {
					if(o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && S.getById && 9 === t.nodeType && B && j.relative[o[1].type]) {
						if(t = (j.find.ID(a.matches[0].replace(Se, Ae), t) || [])[0], !t) return n;
						e = e.slice(o.shift().value.length)
					}
					for(i = Te.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !j.relative[s = a.type]);)
						if((l = j.find[s]) && (r = l(a.matches[0].replace(Se, Ae), ye.test(o[0].type) && t.parentNode || t))) {
							if(o.splice(i, 1), e = r.length && m(o), !e) return ie.apply(n, r), n;
							break
						}
				}
				return H(e, u)(r, t, !B, n, ye.test(e)), n
			}
			...
			L = n.isXML = function(e) {
				...
				var n = e ? e.ownerDocument || e : z,
					i = n.parentWindow;
				return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, F = n.documentElement, B = !L(n), i && i.frameElement && i.attachEvent("onbeforeunload", function() {
					M()
				}), S.attributes = a(function(e) {
					return e.innerHTML = "<a href='#'></a>", s("type|href|height|width", u, "#" === e.firstChild.getAttribute("href")), s(se, l, null == e.getAttribute("disabled")), e.className = "i", !e.getAttribute("className")
					...
					e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || P.push("\\[" + le + "*(?:value|" + se + ")"), e.querySelectorAll(":checked").length || P.push(":checked")
				}), a(function(e) {
					var t = n.createElement("input");
					t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && P.push("[*^$]=" + le + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || P.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), P.push(",.*:")
					...
					return r ? 1 & r || !S.sortDetached && t.compareDocumentPosition(e) === r ? e === n || $(z, e) ? -1 : t === n || $(z, t) ? 1 : _ ? ae.call(_, e) - ae.call(_, t) : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
				} : function(e, t) {
					var r, i = 0,
						o = e.parentNode,
						a = t.parentNode,
						...
						l = [t];
					if(e === t) return G = !0, 0;
					if(!o || !a) return e === n ? -1 : t === n ? 1 : o ? -1 : a ? 1 : _ ? ae.call(_, e) - ae.call(_, t) : 0;
					if(o === a) return f(e, t);
				...
				var r = j.attrHandle[n.toLowerCase()],
					i = r && ee.call(j.attrHandle, n.toLowerCase()) ? r(e, n, !B) : t;
				...
				preFilter: {
					ATTR: function(e) {
						return e[1] = e[1].replace(Se, Ae), e[3] = (e[4] || e[5] || "").replace(Se, Ae), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)
					},
					CHILD: function(e) {
					...
					PSEUDO: function(e) {
						var n, r = !e[5] && e[2];
						return Te.CHILD.test(e[0]) ? null : (e[3] && e[4] !== t ? e[2] = e[4] : r && be.test(r) && (n = g(r, !0)) && (n = r.indexOf(")", r.length - n) - r.length) && (e[0] = e[0].slice(0, n), e[2] = r.slice(0, n)), e.slice(0, 3))
					}
				},
				filter: {
					TAG: function(e) {
					...
					CLASS: function(e) {
						var t = V[e + " "];
						return t || (t = RegExp("(^|" + le + ")" + e + "(" + le + "|$)")) && V(e, function(e) {
						...
						return 1 === r && 0 === i ? function(e) {
							...
							if(m) {
								...
								if(h = [a ? m.firstChild : m.lastChild], a && v) {
									for(c = m[I] || (m[I] = {}), u = c[e] || [], d = u[0] === X && u[1], p = u[0] === X && u[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)
										if(1 === f.nodeType && ++p && f === t) {
											c[e] = [X, d, p];
											break
										}
								} else if(v && (u = (t[I] || (t[I] = {}))[e]) && u[0] === X) p = u[1];
								else
									for(;
			...
			H = n.compile = function(e, t) {
				...
				return o
			}, j.pseudos.nth = j.pseudos.eq, k.prototype = j.filters = j.pseudos, j.setFilters = new k, S.sortStable = I.split("").sort(Q).join("") === I, M(), [0, 0].sort(Q), S.detectDuplicates = G, ce.find = n, ce.expr = n.selectors, ce.expr[":"] = ce.expr.pseudos, ce.unique = n.uniqueSort, ce.text = n.getText, ce.isXMLDoc = n.isXML, ce.contains = n.contains
		}(e);
	var ke = {};
	...
	ce.fn.extend({
		...
		toggleClass: function(e, t) {
			...
			return ce.isFunction(e) ? this.each(function(n) {
				...
				if("string" === n)
					for(var i, o = 0, a = ce(this), s = t, l = e.match(pe) || []; i = l[o++];) s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i);
					...
					l.send(n.hasContent && n.data || null), r = function(e, i) {
						...
						try {
							if(r && (i || 4 === l.readyState))
								if(r = t, a && (l.onreadystatechange = ce.noop, Qt && delete Yt[a]), i) 4 !== l.readyState && l.abort();
								else {
